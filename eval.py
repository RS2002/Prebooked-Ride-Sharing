...
def get_args():
    ...
    parser.add_argument("--model_pre_path",type=str,default="model_pre.pth")
    ...
    for prebooked_rate in prebooked_rate_list:
        for pooling_rate in pooling_rate_list:
            ...
            for advance_time in advance_time_list:
                ...
                print("Advance Time: {:}".format(advance_time))
                ...
                print(
                    "On-demand Reward {:}, Pre-booked Reward {:}, Total Reward {:}, Idle Time {:}, Utilization Rate {:}, Swap Rate {:}".format(
                        reward, reward_pre, total_reward, idle_time, max_utilization_rate, swap_rate))
