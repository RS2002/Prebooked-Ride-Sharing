...
class Platform():
    ...
    def reset(self,discount_factor=0.99):
        ...
        self.Pickup_Num = [0]*4 # average picking up order numbers of four types
        self.Detour = [0]*4 # average picking up order numbers of four types
